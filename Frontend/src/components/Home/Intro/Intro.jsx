    ...
    return (
        <AnimatedSection>
            <section className="max-w-6xl mx-auto pb-10 lg:space-y-6 space-y-4">
                <AnimatedTitle>
                            <div className="Style-Heading2 lg:hidden">{title}</div>
                        </AnimatedTitle>
                <div className="flex lg:h-[90vh] lg:gap-6 gap-2 items-center justify-center">
                    <div className="flex-1 h-full flex flex-col justify-around ">
                        <AnimatedTitle>
                            <div className="Style-Heading2 flex-1 hidden lg:block">{title}</div>
                        </AnimatedTitle>
                        <AnimatedText>
                            <div className="Style-Text1 flex-1">{desc}</div>
                        </AnimatedText>
                        <AnimatedText>

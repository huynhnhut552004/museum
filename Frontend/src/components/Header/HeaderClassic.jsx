      ...
      <div className={`relative w-full max-w-7xl mx-auto h-full lg:px-6 px-4 font-playfair`}>
        <div className={`absolute lg:top-6 top-2 lg:w-full w-[90%] flex justify-between items-center text-white transition-all duration-500 ${isScrolled ? 'opacity-0 pointer-events-none -translate-y-5' : 'opacity-100 translate-y-0'}`}>
          <div className='flex gap-2 cursor-pointer items-center'>
            ...
            <button type='button' onClick={changelang} className=' p-2 active:bg-[#a8a8a8] lg:hidden transition-all duration-300 text-lg ease-in-out rounded-full'>{lang}</button>
          </div>
          <div className="flex gap-6 items-center">
            <div className='relative text-lg hidden lg:block'>
        ...
        <nav
          ...
          <Link to="#" className='lg:hover:text-[#a8a8a8] transition-all duration-300 ease-in-out whitespace-nowrap'>Diễn đàn & sự kiện</Link>

...
const AuthController = {
    register: asyncHandler(async (req, res) => {
        ...
        if (!email || !password || !fullname) throw createError(ERROR_MESSAGES.MISSING_DATA, HTTP_STATUS.BAD_REQUEST);
    ...
    login: asyncHandler(async (req, res) => {
        ...
        return res.status(HTTP_STATUS.OK).json({ message: AUTH_MESSAGES.LOGIN_SUCCSESS, data: loginData });
    }),
